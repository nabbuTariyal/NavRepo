...
public class HomeController {
	...
	public String loginPost(
		...
		boolean validUser = userService.validUserLogin(username, password);
		if(validUser){
			//model.addAttribute("classActiveLogin", true);
			model.addAttribute("validLoginUser", true);
		}
	...
	public String bookShelf(Model model,Principal principal){
		...
		if(activeBookList.isEmpty()){
			model.addAttribute("emptyList",true);
			return "bookshelf";
		}
		
		model.addAttribute("activeAll",true);
		model.addAttribute("bookList",activeBookList);
	...
	public String updateUserShipping(@RequestParam("id") Long shippingAddressId,
			Principal principal, Model model){
	...
	public String removeCreditCard(@RequestParam("id") Long creditCardId,
			Principal principal, Model model){
	...
	public String removeUserShipping(@RequestParam("id") Long userShippingId,
			Principal principal, Model model){
