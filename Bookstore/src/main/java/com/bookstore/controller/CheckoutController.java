...
public class CheckoutController {
	...
	@Autowired
	private MailConstructor mailConstruct;
	...
	public String checkout(
		...
		for(CartItem cartItem: cartItemList){
			if(cartItem.getBook().getInStockNumber() < cartItem.getQty()){
				model.addAttribute("notEnoughCart",true);
				return "forward:/shoppingCart/cart";
			}
		}	
	...
	public String checkoutPost(
		...
		if(shippingAddress.getShippingAddressName().isEmpty() || shippingAddress.getShippingAddressStreet1().isEmpty() ||
				...
				payment.getCVC()==0 || billingAddress.getBillingAddressState().isEmpty() ||
				billingAddress.getBillingAddressStreet1().isEmpty() || billingAddress.getBillingAddressName().isEmpty()
				|| billingAddress.getBillingAddressCity().isEmpty() || billingAddress.getBillingAddressZipcode().isEmpty()){
		...
		mailSender.send(mailConstruct.constructOrderConfirmationEmail(user, order, Locale.ENGLISH));
